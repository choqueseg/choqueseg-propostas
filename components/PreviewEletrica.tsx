...
const CAPA_ELETRICA = "/imagens/capa/eletrica.jpg";
...
const PreviewEletrica = forwardRef<HTMLDivElement, Props>(
  function PreviewEletrica({ dados }, ref) {
    const mensagemFechamento = [
      "Olá, CHOQUESEG! Analisei minha proposta elétrica e quero fechar o serviço.",
      "",
            ...
            <div className="relative z-10 p-7">
              ...
              <div className="mt-12 max-w-[78%]">
                <p className="text-2xl font-black leading-tight text-yellow-400">
                  Segurança, organização e eficiência para sua instalação elétrica.
                </p>
        ...
        <Pagina numeroPagina={2} totalPaginas={2}>
          <header className="flex items-center justify-between rounded-[22px] bg-black p-5">
            <div>
              ...
              <h2 className="mt-1 text-3xl font-black uppercase text-white">
                Instalação elétrica com padrão profissional
              </h2>
            </div>
          ...
          <section className="mt-5 grid gap-4 sm:grid-cols-2">
            <Bloco titulo="O que está incluso">
              <Diferencial texto="Fornecimento dos materiais descritos na proposta" />
              <Diferencial texto="Instalação, montagem e testes de funcionamento" />
              <Diferencial texto="Identificação e organização dos circuitos quando aplicável" />
              <Diferencial texto="Organização, acabamento e padrão técnico da instalação" />
            </Bloco>

            <Bloco titulo="Por que escolher a CHOQUESEG">
              <Diferencial texto="Equipe técnica especializada" />
              <Diferencial texto="Materiais de marcas reconhecidas e adequados ao serviço" />
              <Diferencial texto="Atendimento próximo e suporte pós-venda" />
              <Diferencial texto="Soluções elétricas para residências, comércios e empresas" />
            </Bloco>
          </section>
          ...
          <section className="mt-5 rounded-[22px] border border-yellow-400 bg-yellow-50 p-5 text-zinc-950">
            ...
            <p className="mt-3 whitespace-pre-line text-sm font-bold leading-relaxed text-zinc-700">
              {dados.observacoes ||
                "Valores e condições válidos conforme os materiais e serviços descritos nesta proposta. Alterações no escopo, infraestrutura existente ou adequações adicionais poderão gerar revisão do orçamento."}
            </p>
          </section>
            ...
            <div className="flex items-center justify-between gap-5">
              <div>
                <p className="text-2xl font-black uppercase leading-tight text-yellow-400">
                  Vamos deixar sua instalação elétrica mais segura e organizada?
                </p>
